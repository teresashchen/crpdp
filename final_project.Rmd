...
### AE comment: Absolutely incredible work, you two! Your functions and plots are very clean and concise. My only major suggestion would be to add some more description in between code chunks to explain exactly what your data visualizations represent. That will be especially helpful to make your plots clear for people who don't know much about biomechanics. 
```
...
Similarly, knee-ankle CRP is obtained using the following equation: 
