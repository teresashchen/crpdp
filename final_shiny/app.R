...
#I think the reason that your graph isn't changing for the movement types is that you don't have a place for
#the input the user selected above to go in and change the graph at all (here, would be input$select = but it
#doesn't work to just use the input when they are different data frames. I spent some time digging, but 
#I couldn't figure out how to fix this - I'm sorry!!
